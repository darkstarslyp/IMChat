 ...
 */
public class ConversationDetailItemHolder extends CommonViewHolder<IMUser> {
  ...
  public ConversationDetailItemHolder(Context context, ViewGroup root) {
    ...
    itemView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        EventBus.getDefault().post(new ConversationMemberClickEvent(IMUser.getObjectId(), false));
      }
    });
    ...
    itemView.setOnLongClickListener(new View.OnLongClickListener() {
      ...
      public boolean onLongClick(View v) {
        EventBus.getDefault().post(new ConversationMemberClickEvent(IMUser.getObjectId(), true));
        return true;
      }
    });
  }
